"""Shared remediation configuration helpers.

Extracted from remediation_engine/config.py so that api_handler can
read and update remediation config without importing from another
Lambda's package directory.
"""
